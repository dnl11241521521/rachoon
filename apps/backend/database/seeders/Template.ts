  ...
  public async run() {
    ...
    <html>
      ...
      <footer class="section">
        <section class="columns">
          <div class="column">{{template.data.columns.first | urlize | safe}}</div>
          <div class="column">{{template.data.columns.second | urlize | safe}}</div>
          <div class="column">{{template.data.columns.third | urlize | safe}}</div>
        </section>
      </footer>
      ...
      <tbody><tr><td>
        <main class="content">
          <section class="columns section meta">
            ...
            <div class="column">
              <p>{{document.client.name}}<br />{{document.client.data.info.addition}}<br />{{document.client.data.contactPerson.fullName}}<br />{{document.client.data.address.street}}</br>{{document.client.data.address.zip}} {{document.client.data.address.city}}<br />{{document.client.data.address.country}}</p>
            </div>
            <div class="column">
            ...
            <div class="columns">
              ...
              <div class="column has-text-right">
                ...
                {{document.client.data.info.vat}}</p>
              </div>
              </div>
            </div>
          </section>
        <section class="section content">
          ...
          <p>{{t('Payment within %d days.', document.data.dueDays)}}</p>
          </section>
        </main>
